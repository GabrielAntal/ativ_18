...
// Esse arquivo foi o mais lento pois ele retorna uma promise para cada função download, e o await faz com que cada função aguarde a promise ser retornada